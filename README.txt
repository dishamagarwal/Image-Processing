...
Designed two interfaces, one with the methods of the filters and the other with the methods for the transformation.
...
8. I also compressed interfaces ITransform and IFilter into the interface ImageProcessing. Since
   there might be more, might add to process an image, and with the increasing number of files,
...
11.Extracted the interface for multiLayers as it did not have that earlier.
12.Changed the view according to the new gui to incorporate it


--------------------------------------------------------------
------------Additional Changes For Extra Features------------
--------------------------------------------------------------
...
as greyscale and sepia. Did this in order to contain everything that is considered 
